...
reuse graphene-pydantic code to convert flask-boiler field to
graphene field.

Ref: https://github.com/graphql-python/graphene-pydantic/blob/master/graphene_pydantic/converters.py
...
from flask_boiler.attrs.attribute import AttributeBase


def convert_fb_input_field(
    field: AttributeBase,
    **field_kwargs,
) -> InputField:
    """
